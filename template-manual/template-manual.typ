...
第~@ssec:bib-caution~節はこのテンプレートに限らない，一般的に学術論文等で参考文献を載せる際に注意すべき点をまとめています．
...
- Harvard 方式
  ...
  - et al. は，ラテン語で「そしてその他（の人々）」を意味する et alii（男性・混合複数），et aliae（女性複数），et alia（中性複数）に由来する略語．_Italic_ 体で _et al._ と表記することも多い．
...
どちらの方式で書いても構いませんが，レポート全体を通して一貫した引用方法を採用するようにしてください．
...
`bib` ファイルの書き方は #link("https://github.com/matsukawa-group/Meiji-mech_thesis_template_Typst")[`Meiji-mech_thesis_template_Typst`] 内の #link("https://github.com/matsukawa-group/Meiji-mech_thesis_template_Typst/blob/main/template-manual/template-manual.pdf")[`template-manual.pdf`] で詳細に書いてあるのでそちらをよく読んでください．
